                                                ...
                                                <div class="flex justify-center items-center space-x-2">
                                                    ...
                                                    @if ($pengajuan->status == 'pending')
                                                        ...
                                                        <form id="deleteForm-{{ $pengajuan->id }}" method="POST" action="{{ route('pengurus.pengajuan.destroy', $pengajuan->id) }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" onclick="confirmDelete({{ $pengajuan->id }}, '{{ addslashes($pengajuan->kode_pengajuan) }}')" class="text-red-500 hover:text-red-700 p-2 rounded-lg hover:bg-red-50 transition-all" title="Hapus Pengajuan">
